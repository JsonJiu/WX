...
typedef struct CHECKPRESULT_ST
{
    ...
    unsigned char FindESAMID[8];          //存储ESAMID
...
#define     MASTER_IMEI_CLOSED          8
#define     MASTER_ICCID_CLOSED         9
#define     MASTER_ESAM_CLOSED          10
#define     MASTER_CHECK_THREE          11
