		    ...
		    if(buf[Index_VolumeData] == CheckResult.DeviceID)
                    {
                         ...
                         memset( ((unsigned char *)&CheckResult.MeterTYP), 0xFF, (sizeof(CHECKPRESULT_S) - 1) );
            ...
            switch(datamark)
            {
                ...
                case DEV_GETCHECK_RESULT://查询上告结果
                    ...
                    else
                    {
                        ...
                        len++;
                        memset(&buf[Index_VolumeData+len], 0xff, sizeof(CHECKPRESULT_S)-1);
                        len += sizeof(CHECKPRESULT_S)-1;
                    }
                    len--;
                    break;
                    default:return;
