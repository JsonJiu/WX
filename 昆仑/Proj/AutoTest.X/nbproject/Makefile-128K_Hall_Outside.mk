...
ifeq "$(wildcard nbproject/Makefile-local-128K_Hall_Outside.mk)" "nbproject/Makefile-local-128K_Hall_Outside.mk"
include nbproject/Makefile-local-128K_Hall_Outside.mk
endif
endif
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-128K_Hall_Outside.mk dist/${CND_CONF}/${IMAGE_TYPE}/AutoTest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o: ../../Codes/app/app_pcusart_protocol.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -DDEF_HALL_OUTSIDE -DDEF_DAOWEI_CHECK -I"../../Codes/app" -I"../../Codes/board" -I"../../Codes/bsp" -I"../../Codes/CBB_CPF" -I"../../Codes/drv" -I"../../Codes/general" -I"../../Codes/drv/lcd" -I"../../simple/ProjTest" -I"../../Codes/bsp/CBB_MCU_308_ForGprs.X" -I"../../Codes/drv/m2m_uart" -I"../../Codes/drv/ADC" -I"../../Codes/app/PowerManage" -MMD -MF "${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o.d" -o ${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o ../../Codes/app/app_pcusart_protocol.c    
...
${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o: ../../Codes/app/app_pcusart_protocol.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o.ok ${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o.err 
	@${RM} ${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -DDEF_HALL_OUTSIDE -DDEF_DAOWEI_CHECK -I"../../Codes/app" -I"../../Codes/board" -I"../../Codes/bsp" -I"../../Codes/CBB_CPF" -I"../../Codes/drv" -I"../../Codes/general" -I"../../Codes/drv/lcd" -I"../../simple/ProjTest" -I"../../Codes/bsp/CBB_MCU_308_ForGprs.X" -I"../../Codes/drv/m2m_uart" -I"../../Codes/drv/ADC" -I"../../Codes/app/PowerManage" -MMD -MF "${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o.d" -o ${OBJECTDIR}/_ext/1223384328/app_pcusart_protocol.o ../../Codes/app/app_pcusart_protocol.c    
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/128K_Hall_Outside
	${RM} -r dist/128K_Hall_Outside
