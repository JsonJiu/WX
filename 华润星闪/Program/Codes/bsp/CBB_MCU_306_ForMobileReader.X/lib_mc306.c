...
void MCUPllCfg(void)
{
    ...
    OSCCONbits.NOSC = 0;
    _OSWEN = 0;//?Â¹??
    _SOSCEN = 1;//Ê¹ÄÜ32 kHz
    _POSCEN = 0;//Ö÷Õñµ´Æ÷ÔÚÐÝÃßÄ£Ê½½ûÖ¹¹¤×÷

    _RCDIV = 0;//FRCºó·ÖÆµ Îª0
    _NSTDIS = 1;//½ûÖ¹ÖÐ¶ÏÇ¶Ì×
...
//Ö÷¶¨Ê±Æ÷ÓÃ64·ÖÆµ
#define TIME_CLK_DIV 64
#define TIME_SP_CNT_MS1    (((DEF_MAIN_CLK/2)/TIME_CLK_DIV)/1000)
#define TIME_SP_CNT_MS10   (TIME_SP_CNT_MS1  *  10)
#define TIME_SP_CNT_MS20   (TIME_SP_CNT_MS10 *   2)
#define TIME_SP_CNT_MS50   (TIME_SP_CNT_MS10 *   5)
#define TIME_SP_CNT_MS100  (TIME_SP_CNT_MS10 *  10)
//#define TIME_SP_CNT_MS500  (TIME_SP_CNT_MS10 *  50)
//#define TIME_SP_CNT_MS1000 (TIME_SP_CNT_MS10 * 100)
