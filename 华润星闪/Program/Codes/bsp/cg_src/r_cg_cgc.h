...
/* CRC calculation range (FEA2 - FEA0) */
#define _00_CGC_CRC_AREA0           (0x00U) /* 0 to 3FFBH (16K to 4bytes) */
#define _01_CGC_CRC_AREA1           (0x01U) /* 0 to 7FFBH (32K to 4bytes) */
#define _02_CGC_CRC_AREA2           (0x02U) /* 0 to BFFBH (48K to 4bytes) */
#define _03_CGC_CRC_AREA3           (0x03U) /* 0 to FFFBH (64K to 4bytes) */
#define _04_CGC_CRC_AREA4           (0x04U) /* 0 to 13FFBH (80K to 4bytes) */
#define _05_CGC_CRC_AREA5           (0x05U) /* 0 to 17FFBH (96K to 4bytes) */
#define _06_CGC_CRC_AREA6           (0x06U) /* 0 to 1BFFBH (112K to 4bytes) */
#define _07_CGC_CRC_AREA7           (0x07U) /* 0 to 1FFFBH (128K to 4bytes) */
...
#define _01_CGC_PORT_OUTPUT_LEVEL   (0x01U) /* when PMmn = 0 (output mode), digital output level of the pin is read. */
