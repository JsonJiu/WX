 ...
 *      for RL78 microcontroller R5F10WMG.
 *
...
#ifndef __IOR5F10WMG_H__
#define __IOR5F10WMG_H__

#if !defined(__ARL78__) && !defined(__ICCRL78__)
  #error "IOR5F10WMG.H file for use with RL78 Assembler or Compiler only"
#endif

#if defined(__ARL78__)
  #if __CORE__ != __RL78_1__
    #error "IOR5F10WMG.H file for use with ARL78 option --core rl78_1 only"
  #endif
#endif
#if defined(__ICCRL78__)
  #if __CORE__ != __RL78_1__
    #error "IOR5F10WMG.H file for use with ICCRL78 option --core rl78_1 only"
  #endif
#endif
...
__saddr __no_bit_access __no_init volatile union { unsigned short SDR12; __BITS16 SDR12_bit; struct { union { unsigned char TXD3; __BITS8 TXD3_bit; }; }; } @ 0xFFF14;
__saddr __no_bit_access __no_init volatile union { unsigned short SDR13; __BITS16 SDR13_bit; struct { union { unsigned char RXD3; __BITS8 RXD3_bit; }; }; } @ 0xFFF16;
...
__sfr __no_init volatile union { unsigned char PM13; __BITS8 PM13_bit; } @ 0xFFF2D;
