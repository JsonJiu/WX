											  ...
											  switch(shujubiaoshi)
												{
													...
													case 0xF003:
													  ...
													  Test_linshi_cunchushuju_L.L_CSQ = zufuchua[pHead+84];
														...
														memcpy(Test_linshi_cunchushuju_L.lorakey,&zufuchua[pHead+85],16);
														//到位1信号
														Test_linshi_cunchushuju_L.L_daowei1 = zufuchua[pHead+101];
														//到位2信号
														Test_linshi_cunchushuju_L.L_daowei2 = zufuchua[pHead+102];
														//计量霍尔1信号获取
														Test_linshi_cunchushuju_L.L_jilianghuoer1 = zufuchua[pHead+103];
														//计量霍尔2信号获取
														Test_linshi_cunchushuju_L.L_jilianghuoer2 = zufuchua[pHead+104];
													  //无磁计量信号获取
														Test_linshi_cunchushuju_L.L_wucijiliang = zufuchua[pHead+105];
