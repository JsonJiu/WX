...
uint8_t qiandao[] = {0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,
...
void Uart1_Rx_rec()
{
	if(uart1_Rec_shuju_flag==1&&uart1_Rec_shuju_time_count==0)
	{
		...
		PC_xieyifasong_3(uart1_Uart0_Tx_SendData,uart1_Rec_shuju_neirong_count);
		...
		memset(uart1_Uart0_Tx_SendData,00,lenth_Receive_Send_MAX);
		uart1_Rec_shuju_neirong_count = 0;
	}
}
